...
function Hero({ wedding, variant }: { wedding: WeddingSite; variant: ThemeId }) {
  ...
  return <section id="hero" className="wed-hero timeless-hero">{image}<div className="wed-hero-overlay" /><div className="timeless-frame" aria-hidden="true" />{copy}</section>;
}
